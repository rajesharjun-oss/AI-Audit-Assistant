...
def _build_excel_export(result) -> bytes:
    ...
    with pd.ExcelWriter(output, engine="openpyxl") as writer:
        ...
        _format_excel_table_sheet(writer.book["Deterministic section map"], "DeterministicSectionMap")
        _format_excel_table_sheet(writer.book["Table classification"], "TableClassification")
        _format_excel_table_sheet(writer.book["Contents agreement"], "ContentsAgreement")
